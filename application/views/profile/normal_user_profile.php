		...
		<div class="row">
			<div class="col-md-7">
				<div class="author-box">
					<div class="img-box">
						<img src="images/single-author.jpg" alt="Awesome Image"/>
					</div>
...
<section class="recipe-user-content sec-padding">
	<div class="thm-container">
		<div class="tab-title">
			<ul role="tablist">
				<li class="active" data-tab-name="recipes"><a href="#recipes" aria-controls="recipes" role="tab" data-toggle="tab">REcipes  (25)</a></li>
				<li data-tab-name="articles"><a href="#articles" aria-controls="articles" role="tab" data-toggle="tab">articles (8)</a></li>
				<li data-tab-name="bookmark"><a href="#bookmark" aria-controls="bookmark" role="tab" data-toggle="tab">bookmark (18)</a></li>
			</ul>
		</div>
