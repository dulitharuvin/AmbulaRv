                ...
                <div class="single-post-wrapper">
                    ...
                    <form action="/AmbulaRV/recipe/submitRecipe" method="post" id="contact-form" class="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <p>Optional: If you have recipe video on Youtube. Vimeo or any of the other supported Embed
                                sites, then
                                you�ll want to use the field abouve. Just paste in the URL (ex.
                                http://youtube/1024_wCtm5s or
                                hppt://vimeo.com/5426201) and it will show up as a pupup by clicking the recipe
                                image.</p>
                        </div>
                        <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="select-menu" id="category">
                                        ...
                                        foreach ($catArray as $category) {
                                            ...
                                            <option
                                                value="<?= $category['idCategory'] ?>"><?= $category['title'] ?></option>
                                            <?php
                                        } ?>
                                    </select>
                                </div>
                                ...
                                <div class="ingredients-control">
                                    <div class="entry">
                                        <div class="input-group">
                                            <div class="col-md-6">
                                                <input class="form-control" id="recipetitle" name="ingname[]"
                                                       type="text"
                                                       placeholder="Example : sugar , salt"/>
                                            </div>
                                            <div class="col-md-2">
                                                <input class="form-control" name="amount[]" placeholder="0"
                                                       type="text"/>
                                            </div>
                                            <div class="col-md-3">
