        ...
        <div class="row">
            ...
            <div class="col-md-8 pull-left has-side-background ">
                ...
                <div class="single-post-wrapper">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea comm odo consequat. Duis aute irure dolor in reprehenderit in voluptate velit.</p>
                    <br>
                    <form action="#" class="contact-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" >
                            <p>Optional: If you have recipe video on Youtube. Vimeo or any of the other supported Embed sites, then you’ll want to use the field abouve. Just paste in the URL (ex. http://youtube/1024_wCtm5s or hppt://vimeo.com/5426201) and it will show up as a pupup by clicking the recipe image.</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Summery"></textarea>
                                    <p>Add any other notes like recipe source, coloking hints etc. This section will show up under the cooking directions.</p>
                                </div>
                            </div>
                            <br>
                            <div class="col-md-12">
                                <div class="form-group mb0">
                                    ...
                                    <p>The submitted recipe will only be visible to you until it has been approved by an adminstrator.</p>
